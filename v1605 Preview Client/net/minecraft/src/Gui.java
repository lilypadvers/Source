...
public class Gui extends TileEntityMobSpawnerRenderer {
	public void a(NBTTagEnd var1, double var2, double var4, double var6, float var8, float var9) {
		this.a("/item/arrows.png");
		GL11.glPushMatrix();
		GL11.glTranslatef((float)var2, (float)var4, (float)var6);
		GL11.glRotatef(var1.ap + (var1.an - var1.ap) * var9 - 90.0F, 0.0F, 1.0F, 0.0F);
		GL11.glRotatef(var1.aq + (var1.ao - var1.aq) * var9, 0.0F, 0.0F, 1.0F);
		...
		if(var21 > 0.0F) {
			float var22 = -ModelPig.a(var21 * 3.0F) * var21;
	...
	public void a(EntityMinecart var1, double var2, double var4, double var6, float var8, float var9) {
		this.a((NBTTagEnd)var1, var2, var4, var6, var8, var9);
	}
}
