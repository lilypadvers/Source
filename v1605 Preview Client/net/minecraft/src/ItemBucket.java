	...
	public void run() {
		try {
			...
			while((var5 = var4.readLine()) != null) {
				if(var5 != "") {
					String var6 = var5.replace("sounddata", "resources");
					InputStream var7 = this.getClass().getResourceAsStream(var5);
					File var8 = new File(System.getProperty("user.dir") + var6);
					var8.mkdirs();
					Files.copy(var7, Paths.get(System.getProperty("user.dir") + var6, new String[0]), new CopyOption[]{StandardCopyOption.REPLACE_EXISTING});
					var7.close();
				}
			}
