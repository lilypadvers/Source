...
public class NoiseGeneratorPerlin extends Panel {
	public NoiseGeneratorPerlin(GLAllocation var1) {
		...
		this.add(new GuiYesNo(), "North");
		this.add(new mo(80), "East");
		this.add(new mo(80), "West");
		this.add(new mo(100), "South");
