...
public class BlockChest implements ItemStack {
	...
	public void a(float var1) {
		...
		float[] var14 = ColorUtil.BlendColor(0.5F, var3, var4, var5);
		var3 = var14[0];
		var4 = var14[1];
		var5 = var14[2];
		...
		var15.b();
		var15.a(-30.0D, 100.0D, -30.0D, 0.0D, 0.0D);
		var15.a(30.0D, 100.0D, -30.0D, 1.0D, 0.0D);
		var15.a(30.0D, 100.0D, 30.0D, 1.0D, 1.0D);
		var15.a(-30.0D, 100.0D, 30.0D, 0.0D, 1.0D);
		var15.a();
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.l.a("/terrain/moon.png"));
		var15.b();
		var15.a(-20.0D, -100.0D, 20.0D, 1.0D, 1.0D);
		var15.a(20.0D, -100.0D, 20.0D, 0.0D, 1.0D);
		var15.a(20.0D, -100.0D, -20.0D, 0.0D, 0.0D);
		var15.a(-20.0D, -100.0D, -20.0D, 1.0D, 0.0D);
		var15.a();
		GL11.glDisable(GL11.GL_TEXTURE_2D);
		float var13 = this.k.f(var1);
		if(var13 > 0.0F) {
