...
public class BlockMobSpawner extends RecipesIngots {
	...
	public void a(TileEntityFurnace var1, boolean var2) {
		if(var1 != null) {
			...
			float var5;
			if(var2) {
				var5 = this.aN.nextFloat() * 0.5F;
				float var6 = this.aN.nextFloat() * (float)Math.PI * 2.0F;
				var3.ak = (double)(-ModelPig.a(var6) * var5);
				var3.am = (double)(ModelPig.b(var6) * var5);
				var3.al = (double)0.2F;
			} else {
				var4 = 0.3F;
				var3.ak = (double)(-ModelPig.a(this.an / 180.0F * (float)Math.PI) * ModelPig.b(this.ao / 180.0F * (float)Math.PI) * var4);
				var3.am = (double)(ModelPig.b(this.an / 180.0F * (float)Math.PI) * ModelPig.b(this.ao / 180.0F * (float)Math.PI) * var4);
				var3.al = (double)(-ModelPig.a(this.ao / 180.0F * (float)Math.PI) * var4 + 0.1F);
				var4 = 0.02F;
				var5 = this.aN.nextFloat() * (float)Math.PI * 2.0F;
				var4 *= this.aN.nextFloat();
				var3.ak += Math.cos((double)var5) * (double)var4;
				var3.al += (double)((this.aN.nextFloat() - this.aN.nextFloat()) * 0.1F);
				var3.am += Math.sin((double)var5) * (double)var4;
			}
