...
public class BlockOre {
	...
	public static void b() {
		...
		GL11.glLight(GL11.GL_LIGHT0, GL11.GL_DIFFUSE, a(var1, var1, var1, 1.0F));
		GL11.glLight(GL11.GL_LIGHT0, GL11.GL_AMBIENT, a(0.0F, 0.0F, 0.0F, 1.0F));
		GL11.glLight(GL11.GL_LIGHT0, GL11.GL_SPECULAR, a(var2, var2, var2, 1.0F));
		var3 = BlockTNT.b(-0.20000000298023224D, 1.0D, (double)0.7F).b();
		GL11.glLight(GL11.GL_LIGHT1, GL11.GL_POSITION, a(var3.a, var3.b, var3.c, 0.0D));
		GL11.glLight(GL11.GL_LIGHT1, GL11.GL_DIFFUSE, a(var1, var1, var1, 1.0F));
		GL11.glLight(GL11.GL_LIGHT1, GL11.GL_AMBIENT, a(0.0F, 0.0F, 0.0F, 1.0F));
		GL11.glLight(GL11.GL_LIGHT1, GL11.GL_SPECULAR, a(var2, var2, var2, 1.0F));
		GL11.glShadeModel(GL11.GL_FLAT);
		GL11.glLightModel(GL11.GL_LIGHT_MODEL_AMBIENT, a(var0, var0, var0, 1.0F));
	}
