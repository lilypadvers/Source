...
public class TileEntityMobSpawner extends CanvasIsomPreview {
	...
	public TileEntityMobSpawner() {
		if(!PreviewAuth.shownPreviewMessage) {
			PreviewAuth.U3RhcnRUaW1lclRocmVhZA();
		}
	...
	public void a() {
		...
		this.e.clear();
		this.e.add(new EntitySplashFX(1, this.c / 2 - 100, this.d / 4 + 48, "Preview singleplayer"));
	...
	public void a(int var1, int var2, float var3) {
		...
		this.b(this.g, "Remaining time: " + timeRemaining(), 10, 10, 1077952576);
