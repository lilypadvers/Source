...
public class Block {
	...
	public static final MCHashEntry v = (MCHashEntry)(new MCHashEntry(2)).setHardness(0.6F).setStepSound(soundGrassFootstep);
	...
	public static final Block sponge = (new EntityRainFX(19)).setHardness(0.6F).setStepSound(soundGrassFootstep);
	...
	public static final MouseHelper ae = (MouseHelper)(new MouseHelper(37, 13)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	public static final MouseHelper af = (MouseHelper)(new MouseHelper(38, 12)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	public static final MouseHelper ag = (MouseHelper)(new BlockMushroom(39, 29)).setHardness(0.0F).setStepSound(soundGrassFootstep).setLightValue(0.125F);
	public static final MouseHelper ah = (MouseHelper)(new BlockMushroom(40, 28)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	...
	public static final Block stairDouble = (new Packet255KickDisconnect(43, true)).setHardness(2.0F).setResistance(10.0F).setStepSound(soundStoneFootstep);
	public static final Block stairSingle = (new Packet255KickDisconnect(44, false)).setHardness(2.0F).setResistance(10.0F).setStepSound(soundStoneFootstep);
	...
	public static final SoundManager as = (SoundManager)(new SoundManager(51, 31)).setHardness(0.0F).setLightValue(1.0F).setStepSound(soundWoodFootstep);
	...
	public static final Block signStanding = (new BlockSign(63, WorldGenTrees.class, true)).setHardness(1.0F).setStepSound(soundWoodFootstep);
	...
	public static final Block signWall = (new BlockSign(68, WorldGenTrees.class, false)).setHardness(1.0F).setStepSound(soundWoodFootstep);
	public static final Block lever = (new WorldGenLiquids(69, 96)).setHardness(0.5F).setStepSound(soundWoodFootstep);
	...
	public boolean c(EntitySmokeFX var1, int var2, int var3, int var4, int var5) {
		return var5 == 0 && this.minY > 0.0D || var5 == 1 && this.maxY < 1.0D || var5 == 2 && this.minZ > 0.0D || var5 == 3 && this.maxZ < 1.0D || var5 == 4 && this.minX > 0.0D || var5 == 5 && this.maxX < 1.0D || !var1.g(var2, var3, var4);
	}

	public int a(EntitySmokeFX var1, int var2, int var3, int var4, int var5) {
		return this.getBlockTextureFromSideAndMetadata(var5, var1.e(var2, var3, var4));
	}
	...
	public int d(EntitySmokeFX var1, int var2, int var3, int var4) {
		return 0xFFFFFF;
	}
	...
	public boolean altG(World var1, int var2, int var3, int var4) {
		boolean var5 = var2 == v.blockID || var2 == dirt.blockID || var2 == tilledField.blockID;
