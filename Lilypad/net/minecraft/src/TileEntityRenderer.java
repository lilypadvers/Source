...
public class TileEntityRenderer {
	...
	private TileEntityRenderer() {
		this.specialRendererMap.put(WorldGenTrees.class, new TileEntitySignRenderer());
	...
	public void renderTileEntity(TileEntity tileEntity, float renderPartialTick) {
		if(tileEntity.getDistanceFrom(this.playerX, this.playerY, this.playerZ) < 4096.0D) {
			float var3 = this.worldObj.c(tileEntity.xCoord, tileEntity.yCoord, tileEntity.zCoord);
