...
public class TileEntity {
	...
	public int getBlockMetadata() {
		return this.worldObj.e(this.xCoord, this.yCoord, this.zCoord);
	}
	...
	public Block getBlockType() {
		return Block.blocksList[this.worldObj.a(this.xCoord, this.yCoord, this.zCoord)];
	}

	static {
		addMapping(TileEntityFurnace.class, "Furnace");
		addMapping(TileEntityChest.class, "Chest");
		addMapping(WorldGenTrees.class, "Sign");
