...
public class RenderPlayer extends RenderLiving {
	...
	protected boolean setArmorModel(EntityPlayer var1, int var2) {
		...
		if(var3 != null) {
			...
			if(var4 instanceof BlockFlower) {
				BlockFlower var5 = (BlockFlower)var4;
				this.loadTexture("/armor/" + armorFilenamePrefix[var5.aY] + "_" + (var2 == 2?2:1) + ".png");
