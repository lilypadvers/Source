...
public class RenderGlobal implements IWorldAccess {
	...
	public void a(Vec3D var1, ItemPainting var2, float var3) {
		if(this.renderEntitiesStartupCounter > 0) {
			...
			for(var6 = 0; var6 < var5.size(); ++var6) {
				...
				if(var7.isInRangeToRenderVec3D(var1) && var2.a(var7.boundingBox) && (var7 != this.mc.thePlayer || this.mc.options.w)) {
	...
	public void drawBlockBreaking(EntityPlayer var1, MovingObjectPosition var2, int var3, ItemStack var4, float var5) {
		...
		if(var3 == 0) {
			if(this.damagePartialTime > 0.0F) {
				...
				GL11.glPushMatrix();
				int var7 = this.theWorld.a(var2.blockX, var2.blockY, var2.blockZ);
	...
	public void drawSelectionBox(EntityPlayer var1, MovingObjectPosition var2, int var3, ItemStack var4, float var5) {
		if(var3 == 0 && var2.typeOfHit == 0) {
			...
			int var7 = this.theWorld.a(var2.blockX, var2.blockY, var2.blockZ);
			if(var7 > 0) {
				Block.blocksList[var7].a(this.theWorld, var2.blockX, var2.blockY, var2.blockZ);
	...
	public void a(ItemPainting var1, float var2) {
		for(int var3 = 0; var3 < this.worldRenderers.length; ++var3) {
			if(!this.worldRenderers[var3].skipAllRenderPasses() && (!this.worldRenderers[var3].isInFrustum || (var3 + this.frustumCheckOffset & 15) == 0)) {
				this.worldRenderers[var3].a(var1);
			}
		}
	...
	public void playRecord(String record, int x, int y, int z) {
		...
		this.mc.A.a(record, (float)x, (float)y, (float)z, 1.0F, 1.0F);
	}
	...
	public void playSound(String sound, double posX, double posY, double posZ, float volume, float pitch) {
		...
		if(this.mc.thePlayer.getDistanceSq(posX, posY, posZ) < (double)(var10 * var10)) {
			this.mc.A.b(sound, (float)posX, (float)posY, (float)posZ, volume, pitch);
		}
	...
	public void spawnParticle(String particle, double posX, double posY, double posZ, double motionX, double motionY, double motionZ) {
		...
		if(var14 * var14 + var16 * var16 + var18 * var18 <= 256.0D) {
			if(particle == "bubble") {
				this.mc.effectRenderer.a(new EntityBubbleFX(this.theWorld, posX, posY, posZ, motionX, motionY, motionZ));
			} else if(particle == "smoke") {
				this.mc.effectRenderer.a(new NetworkWriterThread(this.theWorld, posX, posY, posZ));
			} else if(particle == "explode") {
				this.mc.effectRenderer.a(new EntityExplodeFX(this.theWorld, posX, posY, posZ, motionX, motionY, motionZ));
			} else if(particle == "flame") {
				this.mc.effectRenderer.a(new EntityFlameFX(this.theWorld, posX, posY, posZ, motionX, motionY, motionZ));
			} else if(particle == "lava") {
				this.mc.effectRenderer.a(new EntityLavaFX(this.theWorld, posX, posY, posZ));
			} else if(particle == "splash") {
				this.mc.effectRenderer.a(new EntitySplashFX(this.theWorld, posX, posY, posZ, motionX, motionY, motionZ));
			} else if(particle == "largesmoke") {
				this.mc.effectRenderer.a(new NetworkWriterThread(this.theWorld, posX, posY, posZ, 2.5F));
			} else if(particle == "reddust") {
				this.mc.effectRenderer.a(new EntityReddustFX(this.theWorld, posX, posY, posZ));
			} else if(particle == "snowballpoof") {
				this.mc.effectRenderer.a(new EntitySlimeFX(this.theWorld, posX, posY, posZ, Item.snowball));
			} else if(particle == "slime") {
				this.mc.effectRenderer.a(new EntitySlimeFX(this.theWorld, posX, posY, posZ, Item.slimeBall));
			}
