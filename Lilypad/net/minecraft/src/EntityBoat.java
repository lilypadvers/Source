...
public class EntityBoat extends Entity {
	...
	public boolean attackEntityFrom(Entity entity, int damage) {
		...
		if(this.damageTaken > 40) {
			...
			for(var3 = 0; var3 < 2; ++var3) {
				this.entityDropItem(Item.stick.aR, 1, 0.0F);
			}
	...
	protected void updateRiderPosition() {
		...
		this.riddenByEntity.setPosition(this.posX + var1, this.posY + this.getMountedYOffset() + this.riddenByEntity.u(), this.posZ + var3);
	}
