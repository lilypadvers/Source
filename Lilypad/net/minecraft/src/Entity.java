...
public abstract class Entity {
			...
			for(int var30 = var36; var30 <= var27; ++var30) {
				for(int var31 = var25; var31 <= var39; ++var31) {
					for(int var32 = var38; var32 <= var29; ++var32) {
						int var33 = this.worldObj.a(var30, var31, var32);
						if(var33 > 0) {
	...
	public boolean isInsideOfMaterial(Material material) {
		double var2 = this.posY + (double)this.r();
		int var4 = MathHelper.floor_double(this.posX);
		int var5 = MathHelper.floor_float((float)MathHelper.floor_double(var2));
		int var6 = MathHelper.floor_double(this.posZ);
		int var7 = this.worldObj.a(var4, var5, var6);
		if(var7 != 0 && Block.blocksList[var7].material == material) {
			float var8 = BlockFluid.getFluidHeightPercent(this.worldObj.e(var4, var5, var6)) - 0.11111111F;
	...
	public float getBrightness(float renderPartialTick) {
		...
		int var6 = MathHelper.floor_double(this.posZ);
		return this.worldObj.c(var2, var5, var6);
	}
	...
	public boolean H() {
		...
		int var2 = MathHelper.floor_double(this.posY + (double)this.r());
		int var3 = MathHelper.floor_double(this.posZ);
		return this.worldObj.g(var1, var2, var3);
	}
	...
	protected void updateRiderPosition() {
		this.riddenByEntity.setPosition(this.posX, this.posY + this.getMountedYOffset() + this.riddenByEntity.u(), this.posZ);
	}
