...
public class InventoryPlayer implements IInventory {
	...
	public int getTotalArmorValue() {
		...
		for(int var4 = 0; var4 < this.armorInventory.length; ++var4) {
			if(this.armorInventory[var4] != null && this.armorInventory[var4].getItem() instanceof BlockFlower) {
				int var5 = this.armorInventory[var4].getMaxDamage();
				int var6 = this.armorInventory[var4].itemDmg;
				int var7 = var5 - var6;
				var2 += var7;
				var3 += var5;
				int var8 = ((BlockFlower)this.armorInventory[var4].getItem()).aX;
				var1 += var8;
			}
		}
	...
	public void damageArmor(int var1) {
		for(int var2 = 0; var2 < this.armorInventory.length; ++var2) {
			if(this.armorInventory[var2] != null && this.armorInventory[var2].getItem() instanceof BlockFlower) {
