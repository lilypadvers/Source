...
public class ItemRenderer {
	...
	public void renderItemInFirstPerson(float renderPartialTick) {
		...
		GL11.glPopMatrix();
		float var4 = this.mc.theWorld.c(MathHelper.floor_double(var3.posX), MathHelper.floor_double(var3.posY), MathHelper.floor_double(var3.posZ));
		...
		if(this.itemToRender != null) {
			...
			GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTextureForDownloadableImage(this.mc.thePlayer.skinUrl, this.mc.thePlayer.w()));
	...
	public void renderOverlays(float renderPartialTick) {
		...
		if(this.mc.thePlayer.H()) {
			...
			int var6 = this.mc.theWorld.a(var2, var3, var4);
	...
	private void renderFireInFirstPerson(float renderPartialTick) {
		...
		for(int var4 = 0; var4 < 2; ++var4) {
			GL11.glPushMatrix();
			int var5 = Block.as.blockIndexInTexture + var4 * 16;
			int var6 = (var5 & 15) << 4;
			int var7 = var5 & 240;
