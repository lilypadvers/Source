...
public class EntityExplodeFX extends RedstoneUpdateInfo {
	public EntityExplodeFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
		...
		this.i = this.j = this.k = this.rand.nextFloat() * 0.3F + 0.7F;
		this.g = this.rand.nextFloat() * this.rand.nextFloat() * 6.0F + 1.0F;
		this.f = (int)(16.0D / ((double)this.rand.nextFloat() * 0.8D + 0.2D)) + 2;
	}
