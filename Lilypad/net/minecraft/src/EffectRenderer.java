...
public class EffectRenderer {
	...
	public void a(RedstoneUpdateInfo var1) {
		int var2 = var1.c();
	...
	public void updateEffects() {
		for(int var1 = 0; var1 < 4; ++var1) {
			for(int var2 = 0; var2 < this.fxLayers[var1].size(); ++var2) {
				RedstoneUpdateInfo var3 = (RedstoneUpdateInfo)this.fxLayers[var1].get(var2);
				var3.onUpdate();
				if(var3.isDead) {
	...
	public void renderParticles(Entity viewerEntity, float renderPartialTick) {
		...
		RedstoneUpdateInfo.l = viewerEntity.lastTickPosX + (viewerEntity.posX - viewerEntity.lastTickPosX) * (double)renderPartialTick;
		RedstoneUpdateInfo.m = viewerEntity.lastTickPosY + (viewerEntity.posY - viewerEntity.lastTickPosY) * (double)renderPartialTick;
		RedstoneUpdateInfo.n = viewerEntity.lastTickPosZ + (viewerEntity.posZ - viewerEntity.lastTickPosZ) * (double)renderPartialTick;
		...
		for(int var8 = 0; var8 < 3; ++var8) {
			if(this.fxLayers[var8].size() != 0) {
				...
				for(int var11 = 0; var11 < this.fxLayers[var8].size(); ++var11) {
					RedstoneUpdateInfo var12 = (RedstoneUpdateInfo)this.fxLayers[var8].get(var11);
					var12.a(var10, renderPartialTick, var3, var7, var4, var5, var6);
				}
	...
	public void renderLitParticles(Entity entity, float renderPartialTick) {
		...
		if(this.fxLayers[var3].size() != 0) {
			...
			for(int var5 = 0; var5 < this.fxLayers[var3].size(); ++var5) {
				RedstoneUpdateInfo var6 = (RedstoneUpdateInfo)this.fxLayers[var3].get(var5);
				var6.a(var4, renderPartialTick, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			}
	...
	public void addBlockDestroyEffects(int x, int y, int z) {
		int var4 = this.worldObj.a(x, y, z);
		if(var4 != 0) {
			...
			for(int var7 = 0; var7 < var6; ++var7) {
				for(int var8 = 0; var8 < var6; ++var8) {
					for(int var9 = 0; var9 < var6; ++var9) {
						...
						this.a(new EntityDiggingFX(this.worldObj, var10, var12, var14, var10 - (double)x - 0.5D, var12 - (double)y - 0.5D, var14 - (double)z - 0.5D, var5));
					}
				}
			}
	...
	public void addBlockHitEffects(int x, int y, int z, int face) {
		int var5 = this.worldObj.a(x, y, z);
		if(var5 != 0) {
			...
			this.a((new EntityDiggingFX(this.worldObj, var8, var10, var12, 0.0D, 0.0D, 0.0D, var6)).b(0.2F).d(0.6F));
		}
	}
