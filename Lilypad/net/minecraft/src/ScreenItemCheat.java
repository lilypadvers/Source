...
public class ScreenItemCheat extends GuiScreen {
	...
	protected void actionPerformed(GuiButton button) {
		if(button.e) {
			...
			} else if(button.yPosition == 3) {
				this.resetButtons = true;
				this.selectingBlocks = false;
			} else if(button.yPosition == 4) {
			...
			if(button.yPosition >= 4096) {
				this.b.thePlayer.dropPlayerItemWithRandomChoice(new ItemStack(Item.itemsList[button.yPosition - 4096], 1), true);
			} else if(button.yPosition >= 2048) {
				this.b.thePlayer.dropPlayerItemWithRandomChoice(new ItemStack(Block.blocksList[button.yPosition - 2048], 64), true);
			}
	...
	public void drawScreen(int mouseX, int mouseY, float renderPartialTick) {
		...
		if(var5 != 0 && var6 != 0) {
			...
			if(this.createButtons) {
				...
				((GuiButton)this.controlList.get(this.selectingBlocks?0:1)).e = false;
				((GuiButton)this.controlList.get(2)).e = ((GuiButton)this.controlList.get(3)).e = var7 != 1;
			}
