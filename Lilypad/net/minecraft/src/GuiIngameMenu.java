...
public class GuiIngameMenu extends GuiScreen {
	...
	public void initGui() {
		...
		if(this.mc.isMultiplayerWorld()) {
			((GuiButton)this.controlList.get(0)).c = "Disconnect";
		}
	...
	public void drawScreen(int mouseX, int mouseY, float renderPartialTick) {
		...
		if(!this.mc.theWorld.saveWorld(this.updateCounter2++) || this.updateCounter < 20) {
			int var4 = (int)(255.0F * (MathHelper.sin(((float)(this.updateCounter % 10) + renderPartialTick) / 10.0F * (float)Math.PI * 2.0F) * 0.2F + 0.8F));
