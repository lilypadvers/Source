...
public class Explosion {
	public void doExplosion(World var1, Entity var2, double var3, double var5, double var7, float var9) {
				...
				for(var15 = 0; var15 < var12; ++var15) {
					if(var13 == 0 || var13 == var12 - 1 || var14 == 0 || var14 == var12 - 1 || var15 == 0 || var15 == var12 - 1) {
						...
						for(float var31 = 0.3F; var24 > 0.0F; var24 -= var31 * 0.75F) {
							...
							if(var24 > 0.0F) {
								var10.add(new ItemSpade(var32, var33, var34));
							}
		...
		for(int var50 = var48.size() - 1; var50 >= 0; --var50) {
			ItemSpade var51 = (ItemSpade)var48.get(var50);
			int var52 = var51.a;
			int var53 = var51.b;
			int var26 = var51.c;
			...
			if(var54 > 0) {
				Block.blocksList[var54].dropBlockAsItemWithChance(var1, var52, var53, var26, var1.e(var52, var53, var26), 0.3F);
