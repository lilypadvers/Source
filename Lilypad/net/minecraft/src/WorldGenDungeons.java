...
public class WorldGenDungeons extends WorldGenerator {
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
		...
		for(var10 = var3 - var7 - 1; var10 <= var3 + var7 + 1; ++var10) {
			for(var11 = var4 - 1; var11 <= var4 + var6 + 1; ++var11) {
				for(var12 = var5 - var8 - 1; var12 <= var5 + var8 + 1; ++var12) {
					Material var13 = var1.f(var10, var11, var12);
		...
		if(var9 >= 1 && var9 <= 5) {
			for(var10 = var3 - var7 - 1; var10 <= var3 + var7 + 1; ++var10) {
				for(var11 = var4 + var6; var11 >= var4 - 1; --var11) {
					for(var12 = var5 - var8 - 1; var12 <= var5 + var8 + 1; ++var12) {
						...
						} else if(var11 >= 0 && !var1.f(var10, var11 - 1, var12).isSolid()) {
							var1.setBlockWithNotify(var10, var11, var12, 0);
						} else if(var1.f(var10, var11, var12).isSolid()) {
					...
					if(var11 < 3) {
						label204: {
							...
							if(var1.a(var12, var4, var14) == 0) {
								int var15 = 0;
								if(var1.f(var12 - 1, var4, var14).isSolid()) {
									++var15;
								}
								...
								if(var1.f(var12, var4, var14 - 1).isSolid()) {
									++var15;
								}
								...
								if(var15 == 1) {
									...
									TileEntityChest var16 = (TileEntityChest)var1.b(var12, var4, var14);
			...
			TileEntityMobSpawner var19 = (TileEntityMobSpawner)var1.b(var3, var4, var5);
	...
	private ItemStack pickCheckLootItem(Random var1) {
		...
		return var2 == 0?new ItemStack(Item.saddle):(var2 == 1?new ItemStack(Item.ingotIron, var1.nextInt(4) + 1):(var2 == 2?new ItemStack(Item.bread):(var2 == 3?new ItemStack(Item.wheat, var1.nextInt(4) + 1):(var2 == 4?new ItemStack(Item.gunpowder, var1.nextInt(4) + 1):(var2 == 5?new ItemStack(Item.silk, var1.nextInt(4) + 1):(var2 == 6?new ItemStack(Item.bucketEmpty):(var2 == 7 && var1.nextInt(100) == 0?new ItemStack(Item.appleGold):(var2 == 8 && var1.nextInt(2) == 0?new ItemStack(Item.redstone, var1.nextInt(4) + 1):(var2 == 9 && var1.nextInt(10) == 0?new ItemStack(Item.itemsList[Item.fishingRod.aR + var1.nextInt(2)]):null)))))))));
	}
