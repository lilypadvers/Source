...
public class RenderBlocks {
	private EntitySmokeFX a;
	private int overrideBlockTexture = -1;
	private boolean flipTexture = false;
	private boolean renderAllFaces = false;

	public RenderBlocks(EntitySmokeFX var1) {
		this.a = var1;
	}
	...
	public boolean renderBlockTorch(Block block, int x, int y, int z) {
		int var5 = this.a.e(x, y, z);
		Tessellator var6 = Tessellator.instance;
		float var7 = block.c(this.a, x, y, z);
	...
	public boolean renderBlockLever(Block block, int x, int y, int z) {
		...
		float var13 = block.c(this.a, x, y, z);
		if(Block.lightValue[block.blockID] > 0) {
			var13 = 1.0F;
		}
	...
	public boolean renderBlockFire(Block block, int x, int y, int z) {
		...
		double var31;
		double var33;
		if(!this.a.g(x, y - 1, z) && !Block.as.b(this.a, x, y - 1, z)) {
			float var37 = 0.2F;
			float var20 = 0.0625F;
			if((x + y + z & 1) == 1) {
	...
	public boolean renderBlockRedstoneWire(Block block, int x, int y, int z) {
		Tessellator var5 = Tessellator.instance;
		int var6 = block.getBlockTextureFromSideAndMetadata(1, this.a.e(x, y, z));
		if(this.overrideBlockTexture >= 0) {
			var6 = this.overrideBlockTexture;
		}
		...
		boolean var20 = BlockRedstoneWire.b(this.a, x - 1, y, z) || !this.a.g(x - 1, y, z) && BlockRedstoneWire.b(this.a, x - 1, y - 1, z);
		boolean var21 = BlockRedstoneWire.b(this.a, x + 1, y, z) || !this.a.g(x + 1, y, z) && BlockRedstoneWire.b(this.a, x + 1, y - 1, z);
		boolean var22 = BlockRedstoneWire.b(this.a, x, y, z - 1) || !this.a.g(x, y, z - 1) && BlockRedstoneWire.b(this.a, x, y - 1, z - 1);
		boolean var23 = BlockRedstoneWire.b(this.a, x, y, z + 1) || !this.a.g(x, y, z + 1) && BlockRedstoneWire.b(this.a, x, y - 1, z + 1);
		if(!this.a.g(x, y + 1, z)) {
			if(this.a.g(x - 1, y, z) && BlockRedstoneWire.b(this.a, x - 1, y + 1, z)) {
				var20 = true;
			}
			...
			if(this.a.g(x, y, z - 1) && BlockRedstoneWire.b(this.a, x, y + 1, z - 1)) {
				var22 = true;
			}
		...
		var16 = (double)(((float)var9 + 15.99F) / 256.0F);
		if(!this.a.g(x, y + 1, z)) {
			if(this.a.g(x - 1, y, z) && this.a.a(x - 1, y + 1, z) == Block.redstoneWire.blockID) {
			...
			if(this.a.g(x, y, z - 1) && this.a.a(x, y + 1, z - 1) == Block.redstoneWire.blockID) {
	...
	public boolean renderBlockReed(Block block, int x, int y, int z) {
		Tessellator var5 = Tessellator.instance;
		float var6 = block.c(this.a, x, y, z);
		var5.setColorOpaque_F(var6, var6, var6);
		this.renderCrossedSquares(block, this.a.e(x, y, z), (double)x, (double)y, (double)z);
		return true;
	}
	...
	public boolean renderBlockCrops(Block block, int x, int y, int z) {
		...
		float var6 = block.c(this.a, x, y, z);
		var5.setColorOpaque_F(var6, var6, var6);
		this.renderBlockCropsImpl(block, this.a.e(x, y, z), (double)x, (double)((float)y - 0.0625F), (double)z);
		return true;
	}
	...
	public boolean renderBlockFluids(Block block, int x, int y, int z) {
		Tessellator var5 = Tessellator.instance;
		boolean var6 = block.c(this.a, x, y + 1, z, 1);
		boolean var7 = block.c(this.a, x, y - 1, z, 0);
		boolean[] var8 = new boolean[]{block.c(this.a, x, y, z - 1, 2), block.c(this.a, x, y, z + 1, 3), block.c(this.a, x - 1, y, z, 4), block.c(this.a, x + 1, y, z, 5)};
		if(!var6 && !var7 && !var8[0] && !var8[1] && !var8[2] && !var8[3]) {
			...
			if(this.renderAllFaces || var6) {
				...
				float var25 = (float)BlockFluid.a(this.a, x, y, z, var18);
				if(var25 > -999.0F) {
			...
			if(this.renderAllFaces || var7) {
				float var48 = block.c(this.a, x, y - 1, z);
			...
			for(var24 = 0; var24 < 4; ++var24) {
				...
				if(this.renderAllFaces || var8[var24]) {
					...
					float var47 = block.c(this.a, var49, y, var27);
					if(var24 < 2) {
						var47 *= var12;
					} else {
						var47 *= var13;
	...
	private float getFluidHeight(int x, int y, int z, Material material) {
		...
		for(int var7 = 0; var7 < 4; ++var7) {
			...
			if(this.a.f(var8, y + 1, var10) == material) {
				return 1.0F;
			}

			Material var11 = this.a.f(var8, y, var10);
			if(var11 == material) {
				int var12 = this.a.e(var8, y, var10);
				if(var12 >= 8 || var12 == 0) {
	...
	public void renderBlockFallingSand(Block block, World worldObj, int x, int y, int z) {
		...
		float var11 = block.c(worldObj, x, y, z);
		float var12 = block.c(worldObj, x, y - 1, z);
		if(var12 < var11) {
			var12 = var11;
		}
		...
		var12 = block.c(worldObj, x, y + 1, z);
		if(var12 < var11) {
			var12 = var11;
		}
		...
		var12 = block.c(worldObj, x, y, z - 1);
		if(var12 < var11) {
			var12 = var11;
		}
		...
		var12 = block.c(worldObj, x - 1, y, z);
		if(var12 < var11) {
			var12 = var11;
		}
	...
	public boolean renderStandardBlockWithColorMultiplier(Block block, int x, int y, int z, float var5, float var6, float var7) {
		...
		float var26 = block.c(this.a, x, y, z);
		float var27;
		if(this.renderAllFaces || block.c(this.a, x, y - 1, z, 0)) {
			var27 = block.c(this.a, x, y - 1, z);
			var8.setColorOpaque_F(var14 * var27, var18 * var27, var22 * var27);
			this.renderBottomFace(block, (double)x, (double)y, (double)z, block.a(this.a, x, y, z, 0));
			var9 = true;
		}

		if(this.renderAllFaces || block.c(this.a, x, y + 1, z, 1)) {
			var27 = block.c(this.a, x, y + 1, z);
			...
			this.renderTopFace(block, (double)x, (double)y, (double)z, block.a(this.a, x, y, z, 1));
			var9 = true;
		}

		if(this.renderAllFaces || block.c(this.a, x, y, z - 1, 2)) {
			var27 = block.c(this.a, x, y, z - 1);
			if(block.minZ > 0.0D) {
				var27 = var26;
			}

			var8.setColorOpaque_F(var16 * var27, var20 * var27, var24 * var27);
			this.renderEastFace(block, (double)x, (double)y, (double)z, block.a(this.a, x, y, z, 2));
			var9 = true;
		}

		if(this.renderAllFaces || block.c(this.a, x, y, z + 1, 3)) {
			var27 = block.c(this.a, x, y, z + 1);
			if(block.maxZ < 1.0D) {
				var27 = var26;
			}
			...
			var8.setColorOpaque_F(var16 * var27, var20 * var27, var24 * var27);
			this.renderWestFace(block, (double)x, (double)y, (double)z, block.a(this.a, x, y, z, 3));
			var9 = true;
		}

		if(this.renderAllFaces || block.c(this.a, x - 1, y, z, 4)) {
			var27 = block.c(this.a, x - 1, y, z);
			if(block.minX > 0.0D) {
				var27 = var26;
			}

			var8.setColorOpaque_F(var17 * var27, var21 * var27, var25 * var27);
			this.renderNorthFace(block, (double)x, (double)y, (double)z, block.a(this.a, x, y, z, 4));
			var9 = true;
		}

		if(this.renderAllFaces || block.c(this.a, x + 1, y, z, 5)) {
			var27 = block.c(this.a, x + 1, y, z);
			if(block.maxX < 1.0D) {
				var27 = var26;
			}
			...
			var8.setColorOpaque_F(var17 * var27, var21 * var27, var25 * var27);
			this.renderSouthFace(block, (double)x, (double)y, (double)z, block.a(this.a, x, y, z, 5));
			var9 = true;
		}
	...
	public boolean renderBlockCactus(Block blocki, int x, int y, int z) {
		int var5 = blocki.d(this.a, x, y, z);
		float var6 = (float)(var5 >> 16 & 255) / 255.0F;
		float var7 = (float)(var5 >> 8 & 255) / 255.0F;
		float var8 = (float)(var5 & 255) / 255.0F;
	...
	public boolean renderBlockCactusImpl(Block block, int x, int y, int z, float var5, float var6, float var7) {
		...
		float var25 = var13 * var7;
		float var26 = 0.0625F;
		float var27 = block.c(this.a, x, y, z);
		float var28;
		if(this.renderAllFaces || block.c(this.a, x, y - 1, z, 0)) {
			var28 = block.c(this.a, x, y - 1, z);
	...
	public boolean renderBlockFence(Block block, int x, int y, int z) {
		...
		boolean var8 = false;
		boolean var9 = false;
		if(this.a.a(x - 1, y, z) == block.blockID || this.a.a(x + 1, y, z) == block.blockID) {
			var8 = true;
		}

		if(this.a.a(x, y, z - 1) == block.blockID || this.a.a(x, y, z + 1) == block.blockID) {
			var9 = true;
		}

		boolean var10 = this.a.a(x - 1, y, z) == block.blockID;
		boolean var11 = this.a.a(x + 1, y, z) == block.blockID;
		boolean var12 = this.a.a(x, y, z - 1) == block.blockID;
		boolean var13 = this.a.a(x, y, z + 1) == block.blockID;
		if(!var8 && !var9) {
			var8 = true;
		}
	...
	public boolean renderBlockDoor(Block block, int x, int y, int z) {
		...
		float var10 = 0.8F;
		float var11 = 0.6F;
		float var12 = block.c(this.a, x, y, z);
		float var13 = block.c(this.a, x, y - 1, z);
		if(var6.minY > 0.0D) {
			var13 = var12;
		}
		...
		int var14 = block.a(this.a, x, y, z, 2);
		if(var14 < 0) {
