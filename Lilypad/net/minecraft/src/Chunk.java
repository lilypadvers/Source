...
public class Chunk {
	...
	public ChunkPosition e;
	public ChunkPosition f;
	public ChunkPosition g;
	...
	public Chunk(World worldObj, byte[] blocks, int xPosition, int zPosition) {
		...
		this.blocks = blocks;
		this.e = new ChunkPosition(blocks.length);
		this.f = new ChunkPosition(blocks.length);
		this.g = new ChunkPosition(blocks.length);
	}
	...
	private void relightBlock(int x, int y, int z) {
		...
		if(var5 != var4) {
			...
			int var10;
			for(var10 = var5; var5 > 0 && var9 > 0; this.f.a(x, var5, z, var9)) {
				--var5;
	...
	public boolean setBlockIDWithMetadata(int x, int y, int z, int id, int metadata) {
		...
		if(var8 == id && this.e.a(x, y, z) == metadata) {
			return false;
		} else {
	...
	public TileEntity getChunkBlockTileEntity(int x, int y, int z) {
		ItemSpade var4 = new ItemSpade(x, y, z);
	...
	public void setChunkBlockTileEntity(int x, int y, int z, TileEntity tileEntity) {
		ItemSpade var5 = new ItemSpade(x, y, z);
	...
	public int setChunkData(byte[] blocks, int minX, int minY, int minZ, int maxX, int maxY, int maxZ, int size) {
		...
		for(var9 = minX; var9 < maxX; ++var9) {
			for(var10 = minZ; var10 < maxZ; ++var10) {
				...
				var12 = (maxY - minY) / 2;
				System.arraycopy(blocks, size, this.e.a, var11, var12);
				size += var12;
			}
		}
		...
		for(var9 = minX; var9 < maxX; ++var9) {
			for(var10 = minZ; var10 < maxZ; ++var10) {
				var11 = (var9 << 11 | var10 << 7 | minY) >> 1;
				var12 = (maxY - minY) / 2;
				System.arraycopy(blocks, size, this.g.a, var11, var12);
				size += var12;
			}
		}
		...
		for(var9 = minX; var9 < maxX; ++var9) {
			for(var10 = minZ; var10 < maxZ; ++var10) {
				var11 = (var9 << 11 | var10 << 7 | minY) >> 1;
				var12 = (maxY - minY) / 2;
				System.arraycopy(blocks, size, this.f.a, var11, var12);
				size += var12;
			}
		}
