...
public class EntityArrow extends Entity {
	...
	public void onUpdate() {
		...
		if(this.inData) {
			int var1 = this.worldObj.a(this.xTile, this.yTile, this.zTile);
			if(var1 == this.inTile) {
				++this.ticksInGround;
		...
		if(var3 != null) {
			if(var3.entityHit != null) {
				...
				this.inTile = this.worldObj.a(this.xTile, this.yTile, this.zTile);
	...
	public void onCollideWithPlayer(EntityPlayer entityPlayer) {
		if(this.inData && this.shootingEntity == entityPlayer && this.arrowShake <= 0 && entityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.arrow.aR, 1))) {
