...
class MinecartTrackLogic {
	...
	public MinecartTrackLogic(ClassIf var1, World var2, int var3, int var4, int var5) {
		...
		this.trackY = var4;
		this.trackZ = var5;
		this.trackMetadata = var2.e(var3, var4, var5);
	...
	private void calculateConnectedTracks() {
		...
		if(this.trackMetadata == 0) {
			this.connectedTracks.add(new ItemSpade(this.trackX, this.trackY, this.trackZ - 1));
			this.connectedTracks.add(new ItemSpade(this.trackX, this.trackY, this.trackZ + 1));
		} else if(this.trackMetadata == 1) {
			this.connectedTracks.add(new ItemSpade(this.trackX - 1, this.trackY, this.trackZ));
			this.connectedTracks.add(new ItemSpade(this.trackX + 1, this.trackY, this.trackZ));
		} else if(this.trackMetadata == 2) {
			this.connectedTracks.add(new ItemSpade(this.trackX - 1, this.trackY, this.trackZ));
			this.connectedTracks.add(new ItemSpade(this.trackX + 1, this.trackY + 1, this.trackZ));
		} else if(this.trackMetadata == 3) {
			this.connectedTracks.add(new ItemSpade(this.trackX - 1, this.trackY + 1, this.trackZ));
			this.connectedTracks.add(new ItemSpade(this.trackX + 1, this.trackY, this.trackZ));
		} else if(this.trackMetadata == 4) {
			this.connectedTracks.add(new ItemSpade(this.trackX, this.trackY + 1, this.trackZ - 1));
			this.connectedTracks.add(new ItemSpade(this.trackX, this.trackY, this.trackZ + 1));
	...
	private void refreshConnectedTracks() {
		for(int var1 = 0; var1 < this.connectedTracks.size(); ++var1) {
			MinecartTrackLogic var2 = this.a((ItemSpade)this.connectedTracks.get(var1));
			if(var2 != null && var2.isConnectedTo(this)) {
				this.connectedTracks.set(var1, new ItemSpade(var2.trackX, var2.trackY, var2.trackZ));
			} else {
	...
	private boolean isMinecartTrack(int x, int y, int z) {
		return this.worldObj.a(x, y, z) == this.a.blockID || this.worldObj.a(x, y + 1, z) == this.a.blockID || this.worldObj.a(x, y - 1, z) == this.a.blockID;
	}

	private MinecartTrackLogic a(ItemSpade var1) {
		return this.worldObj.a(var1.a, var1.b, var1.c) == this.a.blockID?new MinecartTrackLogic(this.a, this.worldObj, var1.a, var1.b, var1.c):(this.worldObj.a(var1.a, var1.b + 1, var1.c) == this.a.blockID?new MinecartTrackLogic(this.a, this.worldObj, var1.a, var1.b + 1, var1.c):(this.worldObj.a(var1.a, var1.b - 1, var1.c) == this.a.blockID?new MinecartTrackLogic(this.a, this.worldObj, var1.a, var1.b - 1, var1.c):null));
	}

	private boolean isConnectedTo(MinecartTrackLogic minecartTrackLogic) {
		for(int var2 = 0; var2 < this.connectedTracks.size(); ++var2) {
			ItemSpade var3 = (ItemSpade)this.connectedTracks.get(var2);
			if(var3.a == minecartTrackLogic.trackX && var3.c == minecartTrackLogic.trackZ) {
				return true;
			}
		}
	...
	private boolean isInTrack(int x, int y, int z) {
		for(int var4 = 0; var4 < this.connectedTracks.size(); ++var4) {
			ItemSpade var5 = (ItemSpade)this.connectedTracks.get(var4);
			if(var5.a == x && var5.c == z) {
				return true;
			}
		}
	...
	private boolean canConnectTo(MinecartTrackLogic minecartTrackLogic) {
		if(this.isConnectedTo(minecartTrackLogic)) {
			...
			ItemSpade var2 = (ItemSpade)this.connectedTracks.get(0);
			if(minecartTrackLogic.trackY == this.trackY && var2.b == this.trackY) {
							}
	...
	private void connectToNeighbor(MinecartTrackLogic minecartTrackLogic) {
		this.connectedTracks.add(new ItemSpade(minecartTrackLogic.trackX, minecartTrackLogic.trackY, minecartTrackLogic.trackZ));
		...
		if(var6 == 0) {
			if(this.worldObj.a(this.trackX, this.trackY + 1, this.trackZ - 1) == this.a.blockID) {
				var6 = 4;
			}
		...
		if(var6 == 1) {
			if(this.worldObj.a(this.trackX + 1, this.trackY + 1, this.trackZ) == this.a.blockID) {
				var6 = 2;
			}
	...
	private boolean canConnectFrom(int x, int y, int z) {
		MinecartTrackLogic var4 = this.a(new ItemSpade(x, y, z));
		if(var4 == null) {
			return false;
		} else {
	...
	public void place(boolean powered) {
		...
		for(int var7 = 0; var7 < this.connectedTracks.size(); ++var7) {
			MinecartTrackLogic var8 = this.a((ItemSpade)this.connectedTracks.get(var7));
			if(var8 != null) {
