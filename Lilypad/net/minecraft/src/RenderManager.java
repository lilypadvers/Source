...
public class RenderManager {
	...
	private RenderManager() {
		(this.entityRenderMap = new HashMap()).put(EntitySpider.class, new ItemFood());
		this.entityRenderMap.put(NibbleArray.class, new RenderPig(new ModelPig(), new ModelPig(0.5F), 0.7F));
		this.entityRenderMap.put(EntitySheep.class, new MinecraftError(new ModelSheep(), new ModelSheepFur(), 0.7F));
		this.entityRenderMap.put(EntityCow.class, new RenderCow(new ModelCow(), 0.7F));
		this.entityRenderMap.put(BlockGrass.class, new RenderChicken(new ModelChicken(), 0.3F));
		...
		this.entityRenderMap.put(EntityGiantZombie.class, new Packet59ComplexEntity(new ModelZombie(), 0.5F, 6.0F));
		...
		this.entityRenderMap.put(TileEntitySign.class, new RenderMinecart());
