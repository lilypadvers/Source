...
public class EntityLiving extends Entity {
	...
	protected boolean canEntityBeSeen(Entity entity) {
		return this.worldObj.rayTraceBlocks(Vec3D.createVector(this.posX, this.posY + (double)this.r(), this.posZ), Vec3D.createVector(entity.posX, entity.posY + (double)entity.r(), entity.posZ)) == null;
	}
	...
	public void x() {
		...
		if(this.isOnLadder() && this.H()) {
			this.attackEntityFrom((Entity)null, 1);
		}

		int var8;
		if(this.isOnLadder() && this.isInsideOfMaterial(Material.water)) {
			--this.air;
			if(this.air == -20) {
				this.air = 0;
	...
	protected void fall(float distance) {
		...
		if(var2 > 0) {
			...
			int var3 = this.worldObj.a(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY - (double)0.2F - (double)this.yOffset), MathHelper.floor_double(this.posZ));
			if(var3 > 0) {
	...
	public void moveEntityWithHeading(float moveX, float moveZ) {
		...
		if(this.handleWaterMovement()) {
			...
			if(this.onGround) {
				var8 = 0.54600006F;
				int var4 = this.worldObj.a(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.boundingBox.minY) - 1, MathHelper.floor_double(this.posZ));
				if(var4 > 0) {
			...
			if(this.onGround) {
				var8 = 0.54600006F;
				int var5 = this.worldObj.a(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.boundingBox.minY) - 1, MathHelper.floor_double(this.posZ));
				if(var5 > 0) {
			...
			this.moveEntity(this.motionX, this.motionY, this.motionZ);
			if(this.isCollidedHorizontally && this.z()) {
				this.motionY = 0.2D;
			}
	...
	public boolean z() {
		...
		return this.worldObj.a(var1, var2, var3) == Block.ladder.blockID || this.worldObj.a(var1, var2 + 1, var3) == Block.ladder.blockID;
	}
	...
	public void faceEntity(Entity entity, float var2) {
		...
		if(entity instanceof EntityLiving) {
			...
			var5 = var9.posY + (double)var9.r() - (this.posY + (double)this.r());
		} else {
			var5 = (entity.boundingBox.minY + entity.boundingBox.maxY) / 2.0D - (this.posY + (double)this.r());
		}
