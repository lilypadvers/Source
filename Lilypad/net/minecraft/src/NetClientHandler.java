...
public class NetClientHandler extends NetHandler {
	...
	public void handleLogin(Packet1Login packet) {
		this.mc.playerController = new NetworkReaderThread(this.mc, this);
	...
	public void handleVehicleSpawn(Packet23VehicleSpawn packet) {
		...
		Object var8 = null;
		if(packet.type == 10) {
			var8 = new TileEntitySign(this.worldClient, var2, var4, var6, 0);
		}

		if(packet.type == 11) {
			var8 = new TileEntitySign(this.worldClient, var2, var4, var6, 1);
		}

		if(packet.type == 12) {
			var8 = new TileEntitySign(this.worldClient, var2, var4, var6, 2);
		}
	...
	public void handleNamedEntitySpawn(Packet20NamedEntitySpawn packet) {
		...
		RenderSheep var10 = new RenderSheep(this.mc.theWorld, packet.name);
	...
	public void a(EntityChicken var1) {
		Chunk var2 = this.worldClient.getChunkFromChunkCoords(var1.a, var1.b);
		int var3 = var1.a * 16;
		int var4 = var1.b * 16;
	...
	public void a(BlockFire var1) {
		this.netManager.networkShutdown("Got kicked");
		this.disconnected = true;
		this.mc.changeWorld1((World)null);
		this.mc.displayGuiScreen(new GuiConnectFailed("Disconnected by server", var1.a));
	}
	...
	public void handleCollect(Packet22Collect packet) {
		...
		if(var2 != null) {
			...
			this.mc.effectRenderer.a(new EntityPickupFX(this.mc.theWorld, var2, (Entity)var3, -0.5F));
	...
	public void a(ItemFlintAndSteel var1) {
		TileEntity var2 = this.worldClient.b(var1.a, var1.b, var1.c);
		if(var2 != null) {
			var2.readFromNBT(var1.e);
			this.worldClient.markBlocksDirty(var1.a, var1.b, var1.c, var1.a, var1.b, var1.c);
		}
