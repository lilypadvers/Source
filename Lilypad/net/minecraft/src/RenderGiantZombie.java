...
public class RenderGiantZombie extends WorldGenerator {
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
		...
		if(var4 >= 1 && var4 + var6 + 1 <= 128) {
			...
			if(!var7) {
				...
				if((var8 == Block.v.blockID || var8 == Block.dirt.blockID) && var4 < 128 - var6 - 1) {
					...
					for(var16 = var4 - 3 + var6; var16 <= var4 + var6; ++var16) {
						...
						for(var12 = var3 - var11; var12 <= var3 + var11; ++var12) {
							...
							for(int var14 = var5 - var11; var14 <= var5 + var11; ++var14) {
								...
								if((Math.abs(var13) != var11 || Math.abs(var15) != var11 || var2.nextInt(2) != 0 && var10 != 0) && !Block.opaqueCubeLookup[var1.a(var12, var16, var14)]) {
