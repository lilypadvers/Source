...
public class Item {
	...
	public static Item shovel = (new ItemArmor(0, 2)).setIconIndex(82);
	...
	public static Item striker = (new ChunkProviderGenerate(3)).setIconIndex(5);
	public static Item appleRed = (new BlockStep(4, 4)).setIconIndex(10);
	...
	public static Item shovelWood = (new ItemArmor(13, 0)).setIconIndex(80);
	...
	public static Item shovelStone = (new ItemArmor(17, 1)).setIconIndex(81);
	...
	public static Item shovelDiamond = (new ItemArmor(21, 3)).setIconIndex(83);
	...
	public static Item shovelGold = (new ItemArmor(28, 0)).setIconIndex(84);
	...
	public static Item bread = (new BlockStep(41, 5)).setIconIndex(41);
	public static Item helmetLeather = (new BlockFlower(42, 0, 0, 0)).setIconIndex(0);
	public static Item plateLeather = (new BlockFlower(43, 0, 0, 1)).setIconIndex(16);
	public static Item legsLeather = (new BlockFlower(44, 0, 0, 2)).setIconIndex(32);
	public static Item bootsLeather = (new BlockFlower(45, 0, 0, 3)).setIconIndex(48);
	public static Item helmetChain = (new BlockFlower(46, 1, 1, 0)).setIconIndex(1);
	public static Item plateChain = (new BlockFlower(47, 1, 1, 1)).setIconIndex(17);
	public static Item legsChain = (new BlockFlower(48, 1, 1, 2)).setIconIndex(33);
	public static Item bootsChain = (new BlockFlower(49, 1, 1, 3)).setIconIndex(49);
	public static Item helmetSteel = (new BlockFlower(50, 2, 2, 0)).setIconIndex(2);
	public static Item plateSteel = (new BlockFlower(51, 2, 2, 1)).setIconIndex(18);
	public static Item legsSteel = (new BlockFlower(52, 2, 2, 2)).setIconIndex(34);
	public static Item bootsSteel = (new BlockFlower(53, 2, 2, 3)).setIconIndex(50);
	public static Item helmetDiamond = (new BlockFlower(54, 3, 3, 0)).setIconIndex(3);
	public static Item plateDiamond = (new BlockFlower(55, 3, 3, 1)).setIconIndex(19);
	public static Item legsDiamond = (new BlockFlower(56, 3, 3, 2)).setIconIndex(35);
	public static Item bootsDiamond = (new BlockFlower(57, 3, 3, 3)).setIconIndex(51);
	public static Item helmetGold = (new BlockFlower(58, 1, 4, 0)).setIconIndex(4);
	public static Item plateGold = (new BlockFlower(59, 1, 4, 1)).setIconIndex(20);
	public static Item legsGold = (new BlockFlower(60, 1, 4, 2)).setIconIndex(36);
	public static Item bootsGold = (new BlockFlower(61, 1, 4, 3)).setIconIndex(52);
	public static Item flint = (new Item(62)).setIconIndex(6);
	public static Item porkRaw = (new BlockStep(63, 3)).setIconIndex(87);
	public static Item porkCooked = (new BlockStep(64, 8)).setIconIndex(88);
	public static Item painting = (new EntityMinecart(65)).setIconIndex(26);
	public static Item appleGold = (new BlockStep(66, 42)).setIconIndex(11);
	...
	public static Item fishingRod = (new ItemRecord(2000, "hidden_den")).setIconIndex(240);
	public static Item record13 = (new ItemRecord(2001, "lemuria")).setIconIndex(241);
	public final int aR;
	protected int shiftedIndex = 64;
	protected int maxStackSize = 32;
	protected int maxDamage;
	protected boolean aV = false;
	public static Item obsidianArmor0 = (new BlockFlower(90, 4, 5, 0)).setIconIndex(144);
	public static Item obsidianArmor1 = (new BlockFlower(91, 4, 5, 1)).setIconIndex(160);
	public static Item obsidianArmor2 = (new BlockFlower(92, 4, 5, 2)).setIconIndex(176);
	public static Item obsidianArmor3 = (new BlockFlower(93, 4, 5, 3)).setIconIndex(192);
	public static Item obsidianSword = (new ItemSword(94, 5)).setIconIndex(145);
	public static Item obsidianShovel = (new ItemArmor(95, 5)).setIconIndex(161);
	...
	public static Item fryshroom = (new BlockStep(104, 6)).setIconIndex(162);
	public static Item edibleFire = (new BlockStep(105, 2)).setIconIndex(178);
