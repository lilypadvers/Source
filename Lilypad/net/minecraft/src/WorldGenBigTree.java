...
public class WorldGenBigTree extends WorldGenerator {
		...
		for(var11[var5] = var10[var5]; var12 <= var7; ++var12) {
			...
			while(var13 <= var7) {
				...
				if(var15 > (double)var4) {
					...
					int var14 = this.worldObj.a(var11[0], var11[1], var11[2]);
					if(var14 != 0 && var14 != 18) {
						++var13;
					} else {
	...
	int checkBlockLine(int[] var1, int[] var2) {
		...
		if(var3[var5] == 0) {
			...
			for(var15 = var3[var5] + var8; var14 != var15; var14 += var8) {
				...
				int var16 = this.worldObj.a(var13[0], var13[1], var13[2]);
				if(var16 != 0 && var16 != 18) {
					break;
				}
			}
	...
	boolean validTreeLocation() {
		...
		int var3 = this.worldObj.a(this.basePos[0], this.basePos[1] - 1, this.basePos[2]);
		if(var3 != 2 && var3 != 3) {
			return false;
		} else {
