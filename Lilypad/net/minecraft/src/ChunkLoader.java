...
public class ChunkLoader implements IChunkLoader {
	...
	public void storeChunkInCompound(Chunk chunk, World worldObj, NBTTagCompound nbtCompound) {
		...
		nbtCompound.setByteArray("Data", chunk.e.a);
		nbtCompound.setByteArray("SkyLight", chunk.f.a);
		nbtCompound.setByteArray("BlockLight", chunk.g.a);
	...
	public static Chunk loadChunkIntoWorldFromCompound(World worldObj, NBTTagCompound nbtCompound) {
		...
		var4.e = new ChunkPosition(nbtCompound.getByteArray("Data"));
		var4.f = new ChunkPosition(nbtCompound.getByteArray("SkyLight"));
		var4.g = new ChunkPosition(nbtCompound.getByteArray("BlockLight"));
		var4.heightMap = nbtCompound.getByteArray("HeightMap");
		var4.isTerrainPopulated = nbtCompound.getBoolean("TerrainPopulated");
		if(!var4.e.a()) {
			var4.e = new ChunkPosition(var4.blocks.length);
		}

		if(var4.heightMap == null || !var4.f.a()) {
			var4.heightMap = new byte[256];
			var4.f = new ChunkPosition(var4.blocks.length);
			var4.generateSkylightMap();
		}

		if(!var4.g.a()) {
			var4.g = new ChunkPosition(var4.blocks.length);
			var4.doNothing();
		}
