...
public class SpawnerAnimals {
	...
	public void onUpdate(World var1) {
		...
		if(var2 < this.maxSpawns) {
			for(int var3 = 0; var3 < 3; ++var3) {
				this.a(var1, 1, (EntityOtherPlayerMP)null);
			}
		}
	...
	private int a(World var1, int var2, EntityOtherPlayerMP var3) {
		...
		for(var4 = 0; var4 < var1.playerEntities.size(); ++var4) {
			...
			for(var9 = -var8; var9 <= var8; ++var9) {
				for(var10 = -var8; var10 <= var8; ++var10) {
					this.eligibleChunksForSpawning.add(new RenderSpider(var9 + var6, var10 + var7));
				}
			}
		}
		...
		while(var26.hasNext()) {
			RenderSpider var27 = (RenderSpider)var26.next();
			if(var1.rand.nextInt(10) == 0) {
				var7 = var1.rand.nextInt(this.entities.length);
				ItemSpade var28 = this.a(var1, var27.a * 16, var27.b * 16);
				var9 = var28.a;
				var10 = var28.b;
				int var11 = var28.c;
				...
				if(var1.f(var9, var10, var11) != Material.air) {
					return 0;
				}
				...
				for(int var12 = 0; var12 < 3; ++var12) {
					...
					for(int var17 = 0; var17 < 2; ++var17) {
						...
						if(var1.g(var13, var14 - 1, var15) && !var1.g(var13, var14, var15) && !var1.f(var13, var14, var15).getIsLiquid() && !var1.g(var13, var14 + 1, var15)) {
