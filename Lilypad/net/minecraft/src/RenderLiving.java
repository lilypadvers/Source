...
public class RenderLiving extends Render {
	...
	public void doRenderLiving(EntityLiving var1, double var2, double var4, double var6, float var8, float var9) {
		...
		this.mainModel.j = this.renderSwingProgress(var1, var9);
		this.mainModel.k = var1.ridingEntity != null;
		if(this.renderPassModel != null) {
			this.renderPassModel.k = this.mainModel.k;
		}
		...
		try {
			...
			this.loadDownloadableImageTexture(var1.skinUrl, var1.w());
