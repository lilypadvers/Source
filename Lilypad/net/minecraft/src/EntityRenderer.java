...
public class EntityRenderer {
	...
	public void updateRenderer() {
		...
		float var1 = this.mc.theWorld.c(MathHelper.floor_double(this.mc.thePlayer.posX), MathHelper.floor_double(this.mc.thePlayer.posY), MathHelper.floor_double(this.mc.thePlayer.posZ));
	...
	public void updateCameraAndRender(float renderPartialTick) {
		...
		if(this.mc.inGameHasFocus) {
			this.mc.B.c();
			int var2 = this.mc.B.a;
			var3 = this.mc.B.b;
			byte var4 = 1;
			if(this.mc.options.c) {
				var4 = -1;
			}
	...
	public void renderWorld(float renderPartialTick) {
		...
		for(int var11 = 0; var11 < 2; ++var11) {
			...
			this.mc.renderGlobal.a(var12, renderPartialTick);
			...
			var3.a(var2.getPosition(renderPartialTick), var12, renderPartialTick);
		...
		if(this.mc.options.fancyGraphics) {
			...
			for(int var7 = 0; var7 < 150; ++var7) {
				...
				if(var10 <= var4 + 16 && var10 >= var4 - 16) {
					...
					if(var11 > 0) {
						this.mc.effectRenderer.a(new NBTTagString(var2, (double)((float)var8 + var12), (double)((float)var10 + 0.1F) - Block.blocksList[var11].minY, (double)((float)var9 + var13)));
					}
				}
			}
