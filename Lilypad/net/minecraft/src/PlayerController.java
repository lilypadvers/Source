...
public class PlayerController {
	...
	public boolean sendBlockRemoved(int x, int y, int z, int side) {
		...
		Block var6 = Block.blocksList[var5.a(x, y, z)];
		int var7 = var5.e(x, y, z);
		boolean var8 = var5.setBlockWithNotify(x, y, z, 0);
		if(var6 != null && var8) {
			this.mc.A.b(var6.stepSound.getBreakSound(), (float)x + 0.5F, (float)y + 0.5F, (float)z + 0.5F, (var6.stepSound.getVolume() + 1.0F) / 2.0F, var6.stepSound.getPitch() * 0.8F);
