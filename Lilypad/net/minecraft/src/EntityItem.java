...
public class EntityItem extends Entity {
	...
	public void onUpdate() {
		...
		if(this.worldObj.f(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ)) == Material.lava) {
			this.motionY = (double)0.2F;
		...
		if(this.onGround) {
			var1 = 0.58800006F;
			int var2 = this.worldObj.a(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.boundingBox.minY) - 1, MathHelper.floor_double(this.posZ));
			if(var2 > 0) {
	...
	private boolean pushOutOfBlocks(double x, double y, double z) {
		...
		if(Block.opaqueCubeLookup[this.worldObj.a(var7, var8, var9)]) {
			boolean var16 = !Block.opaqueCubeLookup[this.worldObj.a(var7 - 1, var8, var9)];
			boolean var17 = !Block.opaqueCubeLookup[this.worldObj.a(var7 + 1, var8, var9)];
			boolean var18 = !Block.opaqueCubeLookup[this.worldObj.a(var7, var8 - 1, var9)];
			boolean var19 = !Block.opaqueCubeLookup[this.worldObj.a(var7, var8 + 1, var9)];
			boolean var20 = !Block.opaqueCubeLookup[this.worldObj.a(var7, var8, var9 - 1)];
			boolean var21 = !Block.opaqueCubeLookup[this.worldObj.a(var7, var8, var9 + 1)];
			byte var22 = -1;
