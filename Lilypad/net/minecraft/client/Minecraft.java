...
public abstract class Minecraft implements Runnable {
	...
	public void startGame() throws LWJGLException {
		...
		Keyboard.create();
		Mouse.create();
		this.B = new GuiSlider(this.mcCanvas);
	...
	public void run() {
		...
		try {
			...
			while(this.running && (this.mcApplet == null || this.mcApplet.isActive())) {
				...
				this.A.a(this.thePlayer, this.timer.renderPartialTicks);
				GL11.glEnable(GL11.GL_TEXTURE_2D);
	...
	private void clickMouse(int button) {
		if(button != 0 || this.leftClickCounter <= 0) {
			...
			if(this.objectMouseOver == null) {
				...
				Block var6 = Block.blocksList[this.theWorld.a(var2, var3, var4)];
				if(button == 0) {
	...
	private void clickMiddleMouseButton() {
		if(this.objectMouseOver != null) {
			int var1 = this.theWorld.a(this.objectMouseOver.blockX, this.objectMouseOver.blockY, this.objectMouseOver.blockZ);
			if(var1 == Block.v.blockID) {
	...
	public void runTick() {
		...
		if(this.theWorld != null) {
			...
			this.theWorld.difficultySetting = this.options.numberOfOptions;
			if(!this.isGamePaused) {
	...
	public void changeWorld(World world, String title) {
		...
		if(this.theWorld != null) {
			this.theWorld.a(this.loadingScreen);
		}
	...
	private void preloadWorld(String title) {
		...
		this.loadingScreen.d("Building terrain");
		short var2 = 128;
		int var3 = 0;
		...
		for(int var5 = -var2; var5 <= var2; var5 += 16) {
			...
			for(int var8 = -var2; var8 <= var2; var8 += 16) {
				this.loadingScreen.a(var3++ * 100 / var4);
				this.theWorld.a(var6 + var5, 64, var7 + var8);
		...
		this.loadingScreen.d("Simulating world for a bit");
		boolean var9 = true;
