...
public class SoundPool extends BlockLeavesBase {
	...
	public void a() {
		...
		for(var1 = 0; var1 < 16; ++var1) {
			for(var2 = 0; var2 < 16; ++var2) {
				...
				this.g[var1 + var2 * 16] = var3 / 3.2F + this.h[var1 + var2 * 16] * 0.8F;
			}
		}
		...
		for(var2 = 0; var2 < 256; ++var2) {
			var3 = this.f[var2 - this.j * 16 & 255];
			if(var3 > 1.0F) {
				var3 = 1.0F;
			}
