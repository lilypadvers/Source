...
public class lk extends lb {
	...
	public void a(float var1, boolean var2, int var3, int var4) {
		...
		if(this.g.y.editingBlocks) {
			var8.a("Minecraft Alpha v1.0.16.05 [UNR.PREVIEW2]", 2, 2, 0xFFFFFF);
			var8.a(this.g.G, 2, 12, 0xFFFFFF);
			var8.a(this.g.l(), 2, 22, 0xFFFFFF);
			var8.a(this.g.m(), 2, 32, 0xFFFFFF);
			var8.a(this.g.n(), 2, 42, 0xFFFFFF);
