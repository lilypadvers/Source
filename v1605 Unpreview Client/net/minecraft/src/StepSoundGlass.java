...
public class StepSoundGlass extends EntityMinecart {
	private int b = -1;
	private int c = -1;
	private int d = -1;
	private int e = 0;
	...
	public StepSoundGlass(EntitySpider var1) {
		super(var1);
		this.a(0.25F, 0.25F);
	}

	public boolean a(double var1) {
		double var3 = this.ar.b() * 4.0D;
		var3 *= 64.0D;
		return var1 < var3 * var3;
	}

	public StepSoundGlass(EntitySpider var1, RecipesIngots var2) {
		super(var1);
		this.g = var2;
		this.a(0.25F, 0.25F);
		...
		this.ay = 0.0F;
		float var3 = 0.4F;
		this.ak = (double)(-ModelPig.a(this.an / 180.0F * (float)Math.PI) * ModelPig.b(this.ao / 180.0F * (float)Math.PI) * var3);
		this.am = (double)(ModelPig.b(this.an / 180.0F * (float)Math.PI) * ModelPig.b(this.ao / 180.0F * (float)Math.PI) * var3);
		this.al = (double)(-ModelPig.a(this.ao / 180.0F * (float)Math.PI) * var3);
	...
	public void e_() {
		...
		if(var3 != null) {
			...
			for(var8 = 0; var8 < 8; ++var8) {
				this.ad.a("snowballpoof", this.ah, this.ai, this.aj, 0.0D, 0.0D, 0.0D);
			}
		...
		this.ai += this.al;
		this.aj += this.am;
		float var16 = ModelPig.a(this.ak * this.ak + this.am * this.am);
