...
public class BlockFire {
	public final PlayerControllerCreative a;
	public int b;
	public int c;
	public int d;
	public int e;
	...
	public BlockFire(PlayerControllerCreative var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		this.a = var1;
		this.b = var2;
		this.c = var3;
		this.d = var4;
					...
					if(var1.d(var6, 0, var7)) {
						for(int var8 = this.c; var8 <= this.f; ++var8) {
							if(var8 >= 0 && var8 < 128) {
								...
								int var12 = ln.q[var11];
								if(var12 == 0) {
									var12 = 1;
								}

								int var13 = 0;
								if(this.a == PlayerControllerCreative.a) {
									if(var1.k(var6, var8, var7)) {
										var13 = 15;
									}
								} else if(this.a == PlayerControllerCreative.b) {
									var13 = ln.s[var11];
								}
