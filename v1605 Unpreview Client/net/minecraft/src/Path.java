...
public class Path extends EntityCreature implements WorldIso {
	...
	public void k_() {
		...
		if(this.count == 0 && this.i()) {
			int var3 = this.a(this.a[1]);
			this.count = var3;
			this.c = var3;
			if(this.count > 0) {
				var2 = true;
				if(this.a[1] != null) {
					TileEntityFurnace var4 = this.a[1];
					--var4.a;
					if(this.a[1].a == 0) {
						this.a[1] = null;
					}
	...
	private boolean i() {
		if(this.a[0] == null) {
			...
			return var1 >= 0 && (this.a[2] == null || this.a[2].c == var1 && (this.a[2].a < this.c() && this.a[2].a < this.a[2].c() || this.a[2].a < EntityTNTPrimed.c[var1].b()));
		}
	}
	...
	private int d(int var1) {
		return var1 == ln.H.ba?EntityTNTPrimed.m.aQ:(var1 == ln.G.ba?EntityTNTPrimed.n.aQ:(var1 == ln.aw.ba?EntityTNTPrimed.l.aQ:(var1 == ln.E.ba?ln.M.ba:(var1 == EntityTNTPrimed.ao.aQ?EntityTNTPrimed.ap.aQ:(var1 == ln.w.ba?ln.t.ba:(var1 == EntityTNTPrimed.aG.aQ?EntityTNTPrimed.aF.aQ:(var1 == ln.ap.ba?EntityTNTPrimed.obsidianIngot.aQ:(var1 == EntityTNTPrimed.k.aQ?EntityTNTPrimed.blackDye.aQ:(var1 == EntityTNTPrimed.aA.aQ?EntityTNTPrimed.greenDye.aQ:(var1 == ln.ad.ba?EntityTNTPrimed.blueDye.aQ:(var1 == ln.af.ba?EntityTNTPrimed.pinkDye.aQ:(var1 == ln.ag.ba?EntityTNTPrimed.fryshroom.aQ:-1))))))))))));
	}
