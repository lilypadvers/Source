...
public class ItemMinecart {
	...
	private ItemMinecart() {
		...
		this.a(new TileEntityFurnace(EntityTNTPrimed.obsidianSword), new Object[]{"#", "#", "$", Character.valueOf('#'), EntityTNTPrimed.obsidianIngot, Character.valueOf('$'), EntityTNTPrimed.B});
		this.a(new TileEntityFurnace(EntityTNTPrimed.obsidianShovel), new Object[]{"#", "$", "$", Character.valueOf('#'), EntityTNTPrimed.obsidianIngot, Character.valueOf('$'), EntityTNTPrimed.B});
		this.a(new TileEntityFurnace(EntityTNTPrimed.obsidianPick), new Object[]{"###", " $ ", " $ ", Character.valueOf('#'), EntityTNTPrimed.obsidianIngot, Character.valueOf('$'), EntityTNTPrimed.B});
		this.a(new TileEntityFurnace(EntityTNTPrimed.obsidianHoe), new Object[]{"##", " $", " $", Character.valueOf('#'), EntityTNTPrimed.obsidianIngot, Character.valueOf('$'), EntityTNTPrimed.B});
		this.a(new TileEntityFurnace(EntityTNTPrimed.obsidianHoe), new Object[]{"##", "$ ", "$ ", Character.valueOf('#'), EntityTNTPrimed.obsidianIngot, Character.valueOf('$'), EntityTNTPrimed.B});
		this.a(new TileEntityFurnace(EntityTNTPrimed.obsidianAxe), new Object[]{"##", "#$", " $", Character.valueOf('#'), EntityTNTPrimed.obsidianIngot, Character.valueOf('$'), EntityTNTPrimed.B});
		this.a(new TileEntityFurnace(EntityTNTPrimed.obsidianAxe), new Object[]{"##", "$ ", "$ ", Character.valueOf('#'), EntityTNTPrimed.obsidianIngot, Character.valueOf('$'), EntityTNTPrimed.B});
		this.a(new TileEntityFurnace(EntityTNTPrimed.obsidianArmor0), new Object[]{"###", "# #", Character.valueOf('#'), EntityTNTPrimed.obsidianIngot});
		this.a(new TileEntityFurnace(EntityTNTPrimed.obsidianArmor2), new Object[]{"###", "# #", "# #", Character.valueOf('#'), EntityTNTPrimed.obsidianIngot});
		this.a(new TileEntityFurnace(EntityTNTPrimed.obsidianArmor3), new Object[]{"# #", "# #", Character.valueOf('#'), EntityTNTPrimed.obsidianIngot});
		this.a(new TileEntityFurnace(EntityTNTPrimed.obsidianArmor1), new Object[]{"# #", "###", "###", Character.valueOf('#'), EntityTNTPrimed.obsidianIngot});
		this.a(new TileEntityFurnace(ln.woolPink), new Object[]{"#X", Character.valueOf('#'), ln.ab, Character.valueOf('X'), EntityTNTPrimed.pinkDye});
		this.a(new TileEntityFurnace(ln.woolBlue), new Object[]{"#X", Character.valueOf('#'), ln.ab, Character.valueOf('X'), EntityTNTPrimed.blueDye});
		this.a(new TileEntityFurnace(ln.woolGreen), new Object[]{"#X", Character.valueOf('#'), ln.ab, Character.valueOf('X'), EntityTNTPrimed.greenDye});
		this.a(new TileEntityFurnace(ln.woolBlack), new Object[]{"#X", Character.valueOf('#'), ln.ab, Character.valueOf('X'), EntityTNTPrimed.blackDye});
