...
public class lj extends CanvasIsomPreview {
	...
	public void a() {
		int var1;
		for(var1 = 0; var1 < this.i.s.length; ++var1) {
			this.e.add(new RenderCreeper(var1, this.c / 2 - 155 + var1 % 2 * 160, this.d / 6 + 24 * (var1 >> 1), this.i.a(var1)));
		}

		var1 = this.i.s.length;
		this.e.add(new EntitySplashFX(201, this.c / 2 - 100, this.d / 6 + 140, "Gamepad sensitivity: " + InputHandler.lookSens));
	...
	protected void a(EntitySplashFX var1) {
		...
		if(var1.d == 200) {
			...
			var1.c = "Gamepad sensitivity: " + InputHandler.lookSens;
		} else {
			this.k = var1.d;
