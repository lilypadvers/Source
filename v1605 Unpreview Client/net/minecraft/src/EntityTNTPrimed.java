...
public class EntityTNTPrimed {
	...
	public static EntityTNTPrimed obsidianArmor0 = (new mf(89, 4, 5, 0)).a(144);
	public static EntityTNTPrimed obsidianArmor1 = (new mf(90, 4, 5, 1)).a(160);
	public static EntityTNTPrimed obsidianArmor2 = (new mf(91, 4, 5, 2)).a(176);
	public static EntityTNTPrimed obsidianArmor3 = (new mf(92, 4, 5, 3)).a(192);
	public static EntityTNTPrimed obsidianSword = (new EnumOSIsom(93, 5)).a(145);
	public static EntityTNTPrimed obsidianShovel = (new mg(94, 5)).a(161);
	public static EntityTNTPrimed obsidianPick = (new ClippingHelperImplementation(95, 5)).a(177);
	public static EntityTNTPrimed obsidianAxe = (new EntityLiving(96, 5)).a(193);
	public static EntityTNTPrimed obsidianHoe = (new BlockWorkbench(97, 5)).a(209);
	public static EntityTNTPrimed obsidianIngot = (new EntityTNTPrimed(98)).a(208);
	public static EntityTNTPrimed blackDye = (new EntityTNTPrimed(99)).a(146);
	public static EntityTNTPrimed greenDye = (new EntityTNTPrimed(100)).a(147);
	public static EntityTNTPrimed blueDye = (new EntityTNTPrimed(101)).a(148);
	public static EntityTNTPrimed pinkDye = (new EntityTNTPrimed(102)).a(149);
	public static EntityTNTPrimed fryshroom = (new nv(103, 6)).a(162);
