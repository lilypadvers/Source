...
public class ModelBiped implements BlockButton {
	private BlockMushroom c;
	private BlockButton d;
	private GuiSmallButton e;
	private BlockMushroom[] f = new BlockMushroom[1024];
	private EntitySpider g;
	int a = -999999999;
	int b = -999999999;
	private BlockMushroom h;

	public ModelBiped(EntitySpider var1, GuiSmallButton var2, BlockButton var3) {
		this.c = new BlockMushroom(var1, new byte['\u8000'], 0, 0);
		this.c.q = true;
		this.c.p = true;
		this.g = var1;
		this.e = var2;
	...
	public BlockMushroom b(int var1, int var2) {
		if(var1 == this.a && var2 == this.b && this.h != null) {
			...
			if(!this.a(var1, var2)) {
				...
				BlockMushroom var6 = this.c(var1, var2);
				if(var6 == null) {
					if(this.d == null) {
						var6 = this.c;
					} else {
	...
	private BlockMushroom c(int var1, int var2) {
		if(this.e == null) {
			return null;
		} else {
			try {
				BlockMushroom var3 = this.e.a(this.g, var1, var2);
				if(var3 != null) {
					var3.s = this.g.c;
				}
	...
	private void a(BlockMushroom var1) {
		if(this.e != null) {
			try {
	...
	private void b(BlockMushroom var1) {
		if(this.e != null) {
			try {
				var1.s = this.g.c;
	...
	public void a(BlockButton var1, int var2, int var3) {
		BlockMushroom var4 = this.b(var2, var3);
		if(!var4.n) {
			var4.n = true;
			if(this.d != null) {
