...
public class ChunkPosition {
	...
	private void j(float var1) {
		...
		float var11;
		if(this.h.y.g) {
			var11 = (this.e * 30.0F + this.f * 59.0F + this.g * 11.0F) / 100.0F;
		...
		var11 = (float)(1000L - Math.abs(23000L - var2.c % 24000L)) / 1000.0F;
		float[] var14 = ColorUtil.BlendColor(Math.max(0.0F, var11) / 2.0F, this.e, this.f, this.g);
		this.e = var14[0];
		this.f = var14[1];
		this.g = var14[2];
